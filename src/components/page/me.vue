            ...
            <div v-show="!eidtAddress">
                <div class="user-info-container">
                    <div class="user-info-details">
                        <el-tooltip content="修改头像" placement="top">
                            <el-upload action="http://localhost:8080/file/" :on-success="fileHandleSuccess"
                                :file-list="imgFileList" accept="image/*">
                                <el-image style="width: 120px; height: 120px;border-radius: 10px;" :src="userInfo.avatar"
                                    fit="contain" class="myavatar"></el-image>
                            </el-upload>
                        </el-tooltip>

                        <div class="user-info-details-text">
                            <div class="user-info-details-text-nickname">{{ userInfo.nickname }}
                                <el-tag effect="dark" type="warning" v-if="$globalData.merchantLogin">商家</el-tag>
                                <el-tag effect="dark" type="info" v-if="!$globalData.merchantLogin">普通用户</el-tag>
                            </div>
                            ...
                            <el-dialog @close="finishEdit" title="编辑个人信息" :visible.sync="userInfoDialogVisible"
                                width="400px" :modal="false" class="myPersonalDialog">
                ...
                <div class="idle-container">
                    <el-tabs v-model="activeName" @tab-click="handleClick">
                        <el-tab-pane label="我发布的" name="1" v-if="$globalData.merchantLogin"></el-tab-pane>
                        <el-tab-pane label="我下架的" name="2" v-if="$globalData.merchantLogin"></el-tab-pane>
                        <el-tab-pane label="我的购物车" name="3"></el-tab-pane>
                        <el-tab-pane label="我卖出的" name="4" v-if="$globalData.merchantLogin"></el-tab-pane>
                                ...
                                <div class="idle-container-list-item-text">
                                    ...
                                    <div class="idle-item-foot">
                                        ...
                                        <el-button v-if="activeName !== '4' && activeName !== '5'" type="danger" size="mini"
                                            slot="reference" plain @click.stop="handle(activeName, item, index)">{{
