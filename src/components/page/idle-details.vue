            ...
            <div class="idle-details-container">
                <div class="details-header">
                    ...
                    <div class="details-header-buy" :style="'width:' + (isMaster ? '150px;' : '320px;')">
                        <div style="color: red;font-size: 24px;font-weight: 600;padding-right: 20px;">￥{{ idleItemInfo.idlePrice }}</div>
                        ...
                        <el-button v-if="!isMaster && idleItemInfo.idleStatus === 1" type="warning" plain
                            @click="favoriteButton(idleItemInfo)">{{ isFavorite?'从购物车中取消': '加入购物车' }}</el-button>
                ...
                <div class="details-info">
                    ...
                    <div class="details-picture">
                        <el-image v-for="(imgUrl, i) in idleItemInfo.pictureList" :key="i"
                            style="width: 90%;margin-bottom: 2px;" :src="imgUrl" fit="contain" :preview-src-list="idleItemInfo.pictureList"></el-image>
                    </div>
                </div>
                ...
                <div class="message-container" id="replyMessageLocation">
                    ...
                    <div>
                        <div v-for="(mes, index) in messageList" :key="index
